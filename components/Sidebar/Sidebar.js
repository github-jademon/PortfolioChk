...
import NotificationDropdown from "components/_Dropdowns/NotificationDropdown.js";
import UserDropdown from "components/_Dropdowns/UserDropdown.js";
            ...
            <div className="md:min-w-full md:hidden block mb-2 border-b border-solid border-blueGray-200">
              <div className="flex flex-wrap">
                ...
                <div className="w-6/12 flex justify-end">
                  ...
                  {/* <button
                    type="button"
                    className="cursor-pointer text-black opacity-50 md:hidden text-xl leading-none bg-transparent rounded border border-solid border-transparent w-auto h-auto"
